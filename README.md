...
```
vue3, composition api, TypeScript, vite, eslint, prettier
```

## Для того чтобы запустить приложение необходимо пройти 3 этапа

- 1 шаг Установить все зависимости. Рекомендуемая версия node 22.3.0
